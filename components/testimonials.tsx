...
const testimonials = [
  {
    ...
    company: "Disney",
    content:
      "Как создатель контента я постоянно искала инструмент, который помог бы справляться со спросом. Этот ИИ-инструмент кардинально изменил ситуацию и создаёт контент высокого качества в разы быстрее, чем раньше.",
    categories: [1, 3, 5],
  },
  {
    ...
    company: "Samsung",
    content:
      "Я перепробовал несколько инструментов генерации контента, но этот ИИ-инструмент лучший. Он понимает голос моего бренда и постоянно создаёт материалы, которые откликаются аудитории!",
    categories: [1, 2, 4],
  },
  {
    ...
    company: "Rio",
    content:
      "Создание контента раньше было узким местом в нашем процессе, но теперь это не так. Этот интуитивный ИИ-инструмент каждый раз выдаёт контент высшего качества. Будто ещё один член команды, который никогда не спит!",
    categories: [1, 2, 5],
  },
  {
    ...
    company: "Canon",
    content:
      "Качество контента, создаваемого этим ИИ‑инструментом, потрясающее. Он поднял наш контент‑маркетинг на новый уровень, позволив публиковать чаще без потери качества. Настоятельно рекомендую.",
    categories: [1, 4],
  },
  {
    ...
    company: "Cadbury",
    content:
      "Этот ИИ-инструмент буквально спас моё маркетинговое агентство. Теперь мы можем быстро и эффективно создавать качественный контент для множества клиентов. Неоценимый ресурс для нашей команды.",
    categories: [1, 3, 5],
  },
  {
    ...
    company: "Maffell",
    content:
      "Я поражена тем, как хорошо работает этот инструмент с ИИ. Он невероятно универсален и легко создаёт контент для блогов, соцсетей и описаний товаров. Фантастика!",
    categories: [1, 3],
  },
  {
    ...
    company: "Binance",
    content:
      "Меня поразило, как просто создавать контент с этим инструментом! Всего за несколько часов у меня была готова профессиональная платформа, и мой клиент не мог в это поверить.",
    categories: [1, 2, 5],
  },
  {
    ...
    company: "Forbes Inc.",
    content:
      "Мне никогда не нравились сложные веб-инструменты на базе ИИ, поэтому Open PRO идеален для меня. Минималистичный дизайн и простая функциональность делают работу организованной как само собой разумеющееся.",
    categories: [1, 4],
  },
  {
    ...
    company: "Ray Ban",
    content:
      "Я никогда не любила программировать, поэтому найти ИИ-инструмент, не требующий технических навыков, было настоящей мечтой. Этот инструмент превзошёл ожидания, и я с гордостью показываю результаты друзьям.",
    categories: [1, 2],
  },
];
